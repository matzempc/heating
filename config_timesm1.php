...
/*first fetch values*/
exec("./vclient -h 127.0.0.1:3003 -c 'getTimerM1Mo','getTimerM1Di','getTimerM1Mi','getTimerM1Do','getTimerM1Fr','getTimerM1Sa','getTimerM1So'", $output , $retval);
...
if ($_GET["submitted"] && $_GET["code"] == 4710){
	    ...
	    substr($output[$i++], 16, 5) != $_GET["mo42"])
	{
	    ...
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Mo " . $mo11 ." ". $mo12 . " ". $mo21 ." ". $mo22 . " ". $mo31 ." ". $mo32 . " ". $mo41 ." ". 		$mo42 . "'", $write_output , $retval);
		if ($retval == 0){
	    ...
	    substr($output[$i++], 16, 5) != $_GET["di42"])
	{
	    ...
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Di " . $di11 ." ". $di12 . " ". $di21 ." ". $di22 . " ". $di31 ." ". $di32 . " ". $di41 ." ". 		$di42 . "'", $write_output , $retval);
		if ($retval == 0){
	    ...
	    substr($output[$i++], 16, 5) != $_GET["mi42"])
	{
	    ...
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Mi " . $mi11 ." ". $mi12 . " ". $mi21 ." ". $mi22 . " ". $mi31 ." ". $mi32 . " ". $mi41 ." ". 		$mi42 . "'", $write_output , $retval);
		if ($retval == 0){
			//$output[$i] = $_GET["niveaum1"];
		}
	}
	    ...
	    substr($output[$i++], 16, 5) != $_GET["do42"])
	{
	    ...
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Do " . $do11 ." ". $do12 . " ". $do21 ." ". $do22 . " ". $do31 ." ". $do32 . " ". $do41 ." ". 		$do42 . "'", $write_output , $retval);
		if ($retval == 0){
			//$output[$i] = $_GET["niveaum1"];
		}
	}
	    ...
	    substr($output[$i++], 16, 5) != $_GET["fr42"])
	{
	    ...
	    printf("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Fr " . $fr11 ." ". $fr12 . " ". $fr21 ." ". $fr22 . " ". $fr31 ." ". $fr32 . " ". $fr41 ." ". 		$fr42 . "'");
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Fr " . $fr11 ." ". $fr12 . " ". $fr21 ." ". $fr22 . " ". $fr31 ." ". $fr32 . " ". $fr41 ." ". 		$fr42 . "'", $write_output , $retval);
		if ($retval == 0){
			//$output[$i] = $_GET["niveaum1"];
		}
	}
	    ...
	    substr($output[$i++], 16, 5) != $_GET["sa42"])
	{
	    ...
	    printf("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Sa " . $sa11 ." ". $sa12 . " ". $sa21 ." ". $sa22 . " ". $sa31 ." ". $sa32 . " ". $sa41 ." ". 		$sa42 . "'");
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1Sa " . $sa11 ." ". $sa12 . " ". $sa21 ." ". $sa22 . " ". $sa31 ." ". $sa32 . " ". $sa41 ." ". 		$sa42 . "'", $write_output , $retval);
		if ($retval == 0){
			//$output[$i] = $_GET["niveaum1"];
		}
	}
	    ...
	    substr($output[$i++], 16, 5) != $_GET["so42"])
	{
	    ...
	    exec("./vclient -h 127.0.0.1:3003 -c 'setTimerM1So " . $so11 ." ". $so12 . " ". $so21 ." ". $so22 . " ". $so31 ." ". $so32 . " ". $so41 ." ". 		$so42 . "'", $write_output , $retval);
		if ($retval == 0){
			//$output[$i] = $_GET["niveaum1"];
		}
	}
